    ...
    return (
        <>
            <a className="relative flex flex-col items-center group" target="_blank" href={'#'}>
                <div className="w-12 h-12 bg-white flex justify-center items-center rounded-md bg-opacity-20 group-hover:bg-opacity-90 opacity-70 group-hover:opacity-100 transition-transform duration-300 group-hover:-translate-y-1.5">
                    <img src={src} alt={alt} className="w-10 md:w-18 h-auto " />
                </div>
